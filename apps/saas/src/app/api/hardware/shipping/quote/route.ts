// apps/saas/app/api/hardware/shipping_quote/route.ts
export const runtime = "nodejs";

import { json, getBearer, findActorByToken, normalizeStr, readJson } from "@common";   // ✅ alias kullanıldı

const PRODUCTS_FILE = "@data/hardware/products.json";     // ✅ alias kullanıldı
const INVENTORY_FILE = "@data/hardware/inventory.json";   // ✅ alias kullanıldı
