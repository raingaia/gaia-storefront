...
export default async function HardwareSellerHome() {
  // ✅ KRİTİK: 'as Status' ekleyerek TS'in diğer durumları (approved vs) kontrol etmesini sağlıyoruz.
  const status = "not_started" as Status;
...
// --- Orijinal Stillerle Alt Bileşenler ---
